...
const LANG_TRANSLATIONS = {
    'English': {
        ...
        'unsupportedMsg': 'This language is not fully supported across the entire website. Sorry.',
    ...
    'Русский': {
        ...
        'aboutTitle': 'О нас',
        'aboutText': 'Мы всегда стремимся улучшить вашу игру<br>и привлечь ваш вкус к пакетам.<br>Надеемся, вам понравится сайт, пакеты и Telegram канал',
        'packs': 'Пакеты',
        'about': 'О нас',
        'maps': 'Карты',
        ...
        'unsupportedMsg': 'Этот язык не полностью поддерживается на всем сайте. Извините.',
    ...
    'العربية': {
        ...
        'unsupportedMsg': 'هذه اللغة غير مدعومة بالكامل عبر الموقع بأكمله. نأسف.',
    ...
    'Français': {
        ...
        'unsupportedMsg': 'Cette langue n\'est pas entièrement prise en charge sur l\'ensemble du site. Désolé.',
    ...
    'Deutsch': {
        ...
        'unsupportedMsg': 'Diese Sprache wird nicht auf der gesamten Website unterstützt. Entschuldigung.',
    ...
    'Español': {
        ...
        'unsupportedMsg': 'Este idioma no es compatible con todo el sitio web. Lo sentimos.',
    ...
    'Italiano': {
        ...
        'aboutText': 'Ci sforziamo sempre di migliorare il tuo gioco<br>e attirare il tuo gusto per i pacchetti.<br>Speriamo che ti piaccia il sito web, i pacchetti e il canale Telegram',
        'packs': 'Pacchetti',
        'about': 'Informazioni',
        'maps': 'Mappe',
        ...
        'unsupportedMsg': 'Questa lingua non è completamente supportata in tutto il sito web. Ci dispiace.',
    ...
    '中文': {
        ...
        'unsupportedMsg': '此语言在整个网站中未得到完全支持。抱歉。',
    ...
    '日本語': {
        ...
        'unsupportedMsg': 'この言語はウェブサイト全体で完全にはサポートされていません。申し訳ありません。',
    ...
    '한국어': {
        ...
        'unsupportedMsg': '이 언어는 전체 웹사이트에서 완전히 지원되지 않습니다. 죄송합니다.',
